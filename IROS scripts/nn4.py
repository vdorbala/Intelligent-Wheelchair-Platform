...
PATH = 'direct2642_noisy_resnet1.pt'
...
optimizer = optim.SGD(model_ft.parameters(), lr=args.lr, momentum=0.9, weight_decay=0.005)
...
file = open("direct2642_noisy_resnet.csv","w+")
