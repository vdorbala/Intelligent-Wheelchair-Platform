...
# Pre-trained on non noisy. NOw training on noisy.
thresh = 0.05
...
print ("This is nn6. name is Jacobian")
...
optimizer = optim.SGD(model_ft.parameters(), lr=args.lr, momentum=0.9, weight_decay=0)

exp_lr_scheduler = lr_scheduler.StepLR(optimizer, step_size=10, gamma=0.1)

totalset = Dataloader(csv_file='train_all.csv', root_dir='/users/v.dorbala/me/finall',transform=transform)
print ("Size of the dataset is {}".format(len(totalset)))
...
file = open("jaco2642_noisy.csv","w+")
