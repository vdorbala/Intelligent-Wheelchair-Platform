...
img = cv2.imread("./Images/test1/133.jpg")
# img = [cv2.imread(file) for file in glob.glob("/home/vdorbala/ICRA/Images/test1/133.jpg")]
img2 = img
img3 = img
img4 = img
...
while True:
	img = cv2.imread("/home/vdorbala/ICRA/Images/test1/133.jpg")
